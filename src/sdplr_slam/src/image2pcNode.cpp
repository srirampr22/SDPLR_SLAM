...
public:
    Image2PCnode()
    // : subLaserCloud(nh, "/camera/depth/color/points", 100),
    //   yellowMaskSub(nh, "/yellow_mask", 100),
    //   sync(MySyncPolicy(100), subLaserCloud, yellowMaskSub)
    {   
        // ros::NodeHandle nh;
        // sync.registerCallback(boost::bind(&Image2PCnode::callback, this, _1, _2));
